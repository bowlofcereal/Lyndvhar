...
#define RACES_ALL_KINDS list(RACES_DESPISED, RACES_SHUNNED, RACES_TOLERATED, RACES_RESPECTED, RACES_ESTEEMED, RACES_SEELIE)
...
#define CTAG_INQUISITOR		"CAT_INQUISITOR"	// For Inquisitor subclasses
